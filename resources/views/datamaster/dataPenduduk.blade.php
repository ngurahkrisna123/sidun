        ...
        <div class="max-w-6xl mx-auto sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <a href="/add-penduduk" class="btn btn-primary btn-sm">
                        TAMBAH DATA</a>
                    <button type="button" class="btn btn-success btn-sm mb-2" data-toggle="modal" data-target="#importExcel" style="float:right">
            			IMPORT EXCEL
		            </button>
                    
                    <table id="tabelpenduduk" class="display nowrap" style="width:100%; padding-top: 1em;  padding-bottom: 1em; font-size: 14px">
                        <thead> 
                            <tr>
                                <th>NIK</th>
                                <th>No. KK</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="flex">
                                    ...
                                    <a href="#ModalDeletePenduduk{{ $data->idPenduduk}}" data-toggle="modal">
...
<div class="modal fade" id="ModalDeletePenduduk{{ $data->idPenduduk }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/delete-penduduk/{{ $data->idPenduduk }}" class="btn btn-primary">Yes</a>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<form method="post" action="/import-penduduk" enctype="multipart/form-data">
					<div class="modal-content">
						<div class="modal-header">
