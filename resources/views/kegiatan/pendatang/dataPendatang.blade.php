        ...
        <div class="max-w-6xl mx-auto sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    Tabel Data Pendatang
                    
                    <div class="p-6 mt-6 lg:mt-0 rounded shadow bg-white" sytle="width:100vw">
                    
                    <a href="/add-pendatang" class="bg-blue-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 items-end">
                        Tambah Data</a>
                    
                    <table id="tabelpendatang" class="display nowrap" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    <thead> 
                            <tr>
                                <th>NIK</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            @forelse($pendatangs as $data)
                            <tr>
                                <td>{{ $data->nik }}</td>
                                <td>{{ $data->nama }}</td>
                                <td>{{ $data->tglDatang }}</td>
                                ...
                                <td class="flex">
                                    <a href="/edit-pendatang/{{ $data->idPendatang }}" >
                                    ...
                                    <a href="#ModalDeletePendatang{{ $data->idPendatang}}" data-toggle="modal">
...
<!-- Modal Delete Pendatang-->
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">


@foreach ($pendatangs as $data)
<div class="modal fade" id="ModalDeletePendatang{{ $data->idPendatang }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/delete-pendatang/{{ $data->idPendatang }}" class="btn btn-primary">Yes</a>
    ...
    <!-- datatables script -->
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#tabelpendatang').DataTable( {
                        //responsive: true,
                        scrollY:        "300px",
                        scrollX:        true,
                        scrollCollapse: true,
