        ...
        <div class="max-w-6xl mx-auto sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <a href="/add-pindah" class="bg-blue-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 items-end">
                        Tambah Data</a>
                    
                    <table id="tabelpindah" class="display nowrap" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    <thead> 
                            <tr>
                                <th>NIK</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            @forelse($pindahs as $data)
                            <tr>
                                <td>{{ $data->nik }}</td>
                                <td>{{ $data->nama }}</td>
                                <td>{{ $data->tglPindah }}</td>
                                <td>{{ $data->alamatAsal }}</td>
                                <td>{{ $data->alamatPindah }}</td>
                                <td>{{ $data->agama }}</td>
                                <td>{{ $data->jk }}</td>
                                ...
                                <td class="flex">
                                    <a href="/edit-pindah/{{ $data->idPindah }}" >
                                    ...
                                    <a href="#ModalDeletePindah{{ $data->idPindah}}" data-toggle="modal">
...
<div class="modal fade" id="ModalDeletePindah{{ $data->idPindah }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/delete-pindah/{{ $data->idPindah }}" class="btn btn-primary">Yes</a>
    ...
    <!-- datatables script -->
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#tabelpindah').DataTable( {
                        //responsive: true,
                        scrollY:        "300px",
                        scrollX:        true,
                        scrollCollapse: true,
