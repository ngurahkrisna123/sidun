        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @endif
                    <form class="row" action="{{ route('add-pindah') }}" method="POST"
                        ...
                        <div class="col-md-12" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tglPindah" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamatPindah" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Agama :</label>
